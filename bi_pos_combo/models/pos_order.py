...
class ProductProduct(models.Model):
	...
	combo_limit = fields.Integer('Combo Limit')
...
class pos_order_line(models.Model):
	...
	combo_products = fields.Text("Combo Produts")
	...
	def _export_for_ui(self, orderline):
		...
		result['combo_products'] = bool(orderline.combo_products) and orderline.combo_products
