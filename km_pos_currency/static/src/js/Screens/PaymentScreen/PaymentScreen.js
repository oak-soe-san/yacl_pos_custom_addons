odoo.define('km_pos_currency.PaymentScreen', function (require) {
    'use strict';
    ...
    const KmPosMultiCurrPaymentScreen = (PaymentScreen_) =>
                ...
                if(!_.isEmpty(this.env.pos.multicurrencypayment)){
                    ...
                    if (confirmed) {
                        if ($(".pay_amount").val()){
                            ...
                            // KM ADD
                            this.selectedPaymentLine.set_amount_for_change(currency_amount - payload.amount_total_currency, payload.selected_value);
    ...
    Registries.Component.extend(PaymentScreen, KmPosMultiCurrPaymentScreen);
