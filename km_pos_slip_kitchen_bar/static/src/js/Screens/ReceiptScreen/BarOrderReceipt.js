odoo.define('km_pos_slip_kitchen_bar.BarOrderReceipt', function(require) {
    'use strict';
    ...
    class BarOrderReceipt extends PosComponent {
        setup() {
            super.setup();
    ...
    BarOrderReceipt.template = 'BarOrderReceipt';

    Registries.Component.add(BarOrderReceipt);
